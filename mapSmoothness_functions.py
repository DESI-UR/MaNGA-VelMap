...
sys.path.insert(1, '/Users/nityaravi/Documents/GitHub/MaNGA-VelMap/GradientSmoothness-1.0.0/')
#sys.path.append('/home/nravi3/GradientSmoothness-1.0.0/')
from GradientSmoothness.calculate_smoothness import calculate_smoothness
